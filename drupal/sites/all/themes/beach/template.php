...
function phptemplate_preprocess(&$vars, $hook) {
  ...
  $vars['nav_access'] = '
    <ul id="nav-access" class="hidden-beach">
  ...
  */
  ...
  $vars['closure'] .= '
  <p id="theme-credit"><a href="http://drupal.org/project/beach">Beach Theme</a> '. t('Provided By ') . '<a href="http://drupal.in.th/">'.t('Thai Drupal Samosorn').'</a>.'.t('Designed by ').'<a href="http://webzer.net/">Gibbo</a>.</p>
  ';
 ...
 */
function streetbuzz_comment_wrapper($content, $node) {
  global $user;
  $output = '';
