...
2. Make pdf.js file in the pdf.js/build directory by following the README.(might need to install Node.js for the command line to work) 
WARNING: pdf.js is a large file! Consider minifying it. Here is how to https://github.com/mozilla/pdf.js/issues/710#issuecomment-4080540 (need to download google compiler and execute minification in command line)
